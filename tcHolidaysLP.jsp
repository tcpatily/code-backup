...
<cms:include file="../common/reVampCommon/commonCSS.jsp"/>
<link rel="stylesheet" href="/css/tcHolidays/holidaysLP.css">
<cms:include file="../common/reVampCommon/commonJS.jsp"/>
</head>
<body>
...
<div id="header-revamp">
    ...
    <div class="tcHolidaysTheamData mobileAppStrip">
        <cms:include file="../common/reVampCommon/mobileAppStrip.jsp"/>
    </div>
    <div class="clearfix"></div>

    <div class="tcHolidaysTheamData commonLoginSignUp">
        <cms:include file="../common/reVampCommon/commonLoginSignUp.jsp"/>
    </div>
    <div class="clearfix"></div>
</div>
...
<div class="tcHolidaysTheamData" id="hero_section-wrapper">
	<c:set var="pageType" value="holidays" scope="request" />
	<div class="hero_section" data-page-type="${pageType}">
		<cms:container name="holidaysLPMainBanner" type="full"  maxElements="1"/>
                    ...
                    <div class="inner__gapTop ">
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-international" role="tabpanel" aria-labelledby="pills-international-tab">
                                ...
                                <div class="inner__gapTop ">
                                    <a href="/holidays/international-tour-packages" class="btn btn_primary m-auto">View All <img src="../images/tcHolidays/arrow-narrow-up-right.svg" alt=""></a>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="pills-india" role="tabpanel" aria-labelledby="pills-india-tab">
                                ...
                                <div class="inner__gapTop ">
                                    <a href="/holidays/india-tour-packages" class="btn btn_primary m-auto">View All <img src="../images/tcHolidays/arrow-narrow-up-right.svg" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="inner__gapTop">
                        <div class="top_section">
                            ...
                            <div class="wildlife_slideData holidaysLPThomasCookSpecialsSlider d-none d-md-block">
                               ...
                               <div class="wildlife_slideData holidaysLPThomasCookSpecialsSlider d-block d-md-none">
                                    <cms:container name="holidaysLPThomasCookSpecialsSlider-Msite" type="full"  maxElements="1"/> 
                            </div>
                        </div>  
...
<!------Best Selling Packages Start from here------->
	<!------Best Selling Packages------->
    <div class="selling_packages rn__section__gapTop best_selling">
        <div class="container">
            <div class="row gx-0 justify-content-center">
                <div class="col-xxxl-9 col-xxl-12">
                    <div class="main_heading ">
                        ...
                        <div class="filter_inr">
                            <div class="filters_tab comn_filterTab">
                                ...
                                <button class="btn active" data-target=".tabBestSellingTabInternational">International</button>
							 	<button class="btn" data-target=".tabBestSellingTabIndia">India & Around</button>
                            </div>
                        </div>
                    </div>
						<div class="clearfix"></div>
                    <div class="inner__gapTop ">
					<div class="holidaysLPBestSellingPackagesTab tabBestSellingTabInternational">
					<div class="clearfix"></div>
					<div class="tcHolidaysTheamData holidaysLPBestSellingPackagesInternational">
						<cms:container name="holidaysLPBestSellingPackagesInternational" type="full"  maxElements="1"/>
					</div>
					<div class="clearfix"></div>
					</div>
					
					<div class="holidaysLPBestSellingPackagesTab tabBestSellingTabIndia" style="display: none;">
					<div class="clearfix"></div>
					<div class="tcHolidaysTheamData holidaysLPBestSellingPackagesIndia">
						<cms:container name="holidaysLPBestSellingPackagesIndia" type="full"  maxElements="1"/>
					</div>
					<div class="clearfix"></div>
					</div>
...
<!------CTA Form Section Start from here------->
<div class="tcHolidaysTheamData">
    <cms:include file="holidaysJSP/holidaysLPCTAFormSection.jsp"/>
</div>
<div class="clearfix"></div>
<!------CTA Form Section Ends from here------->
...
<!------Explore Holidays By Theme start from here------->
	...
	<div class="container tcHolidaysTheamData holidaysLPExploreHolidaysByTheme">
...
<div class="tcHolidaysTheamData holidaysLPOffersForYou">
    <cms:include file="holidaysJSP/holidaysLPOffersForYou.jsp"/>
</div>
<!------Offers For You Ends from here------->



<!------International Packages start from here ------->

    <div class="international_package rn__section__gapTop">
        <div class="container">
            <div class="row gx-0 justify-content-center">
                <div class="col-xxxl-9 col-xxl-12">
                    <div class="main_heading ">
                        <h4>International Holiday</h4>
                        <!--filters-->
                        <div class="filter_inr">
                            <div class="filters_tab comn_filterTab">
                                <div class="slider"></div>
                                <button class="btn active" data-target=".tabLPInternationalPackagesEurope">Europe</button>
							 	<button class="btn" data-target=".tabLPInternationalPackagesAsia">Asia</button>
								<button class="btn" data-target=".tabLPInternationalPackagesOceania">Oceania</button>
								<button class="btn" data-target=".tabLPInternationalPackagesMiddle">Middle East</button>
								<button class="btn" data-target=".tabLPInternationalPackagesAfrica">Africa</button>
								<button class="btn" data-target=".tabLPInternationalPackagesAmerica">America</button>
						...
						<div class="clearfix"></div>
                        <div class="inner__gapTop ">
                            <div class="tabLPInternationalPackages tabLPInternationalPackagesEurope" style="display: block">
                                <div class="clearfix"></div>
                                <div id="tabLPInternationalPackagesEurope" class="tcHolidaysTheamData ">
                                    <cms:container name="tabLPInternationalPackagesEurope" type="full"  maxElements="1"/>
									<cms:container name="europeViewMoreBtn" type="full"  maxElements="1"/>
                                </div>
                                ...
                                <div class="clearfix"></div>
                            <div class="tabLPInternationalPackages tabLPInternationalPackagesAsia" style="display: none">
                                <div id="tabLPInternationalPackagesAsia" class="tcHolidaysTheamData ">
                                    <cms:container name="tabLPInternationalPackagesAsia" type="full"  maxElements="1"/>
									<cms:container name="asiaViewMoreBtn" type="full"  maxElements="1"/>
									
                                </div>
								 
                            </div>
                                <div class="clearfix"></div>
                            <div class="tabLPInternationalPackages tabLPInternationalPackagesOceania" style="display: none">
                                <div id="tabLPInternationalPackagesOceania" class="tcHolidaysTheamData ">
                                    <cms:container name="tabLPInternationalPackagesOceania" type="full"  maxElements="1"/>
									<cms:container name="oceaniaViewMoreBtn" type="full"  maxElements="1"/>
									
                                </div>
								 
                                <div class="clearfix"></div>
                            </div>
                            <div class="tabLPInternationalPackages tabLPInternationalPackagesMiddle" style="display: none">
                                <div id="tabLPInternationalPackagesMiddle" class="tcHolidaysTheamData ">
                                    <cms:container name="tabLPInternationalPackagesMiddle" type="full"  maxElements="1"/>
									<cms:container name="middleEastViewMoreBtn" type="full"  maxElements="1"/>
                                </div>
								 
                                <div class="clearfix"></div>
                            </div>
                            <div class="tabLPInternationalPackages tabLPInternationalPackagesAfrica" style="display: none">
                                <div id="tabLPInternationalPackagesAfrica" class="tcHolidaysTheamData ">
                                    <cms:container name="tabLPInternationalPackagesAfrica" type="full"  maxElements="1"/>
									<cms:container name="africaViewMoreBtn" type="full"  maxElements="1"/>
                                </div>
								 
                            </div>
							<div class="tabLPInternationalPackages tabLPInternationalPackagesAmerica" style="display: none">
                                <div id="tabLPInternationalPackagesAmerica" class="tcHolidaysTheamData ">
                                    <cms:container name="tabLPInternationalPackagesAmerica" type="full"  maxElements="1"/>
									<cms:container name="americaViewMoreBtn" type="full"  maxElements="1"/>
                                </div>
...
<div class="clearfix"></div>
<!------International Packages Ends from here------->



<!------India & Around Holiday Packages start from here ------>

    <div class="india_package comn_package rn__section__gapTop">
        <div class="container">
            <div class="row gx-0 justify-content-center">
                <div class="col-xxxl-9 col-xxl-12">
                    <div class="main_heading ">
                        <h4>India & Around Holiday</h4>
                        <!--filters-->
                        <div class="filter_inr">
                            <div class="filters_tab comn_filterTab">
                                <div class="slider"></div>
                                <button class="btn active" data-target=".tabLPIndiaPackagesNorth">North</button>
							 	<button class="btn" data-target=".tabLPIndiaPackagesSouth">South</button>
								<button class="btn" data-target=".tabLPIndiaPackagesEast">East</button>
								<button class="btn" data-target=".tabLPIndiaPackagesWest">West</button>
								<button class="btn" data-target=".tabLPIndiaPackagesAround">Around</button>
						...
						<div class="clearfix"></div>
                        <div class="inner__gapTop ">
                            <div class="tabLPIndiaPackages tabLPIndiaPackagesNorth">
                                <div class="clearfix"></div>
                                <div id="tabLPIndiaPackagesNorth" class="tcHolidaysTheamData ">
                                    <cms:container name="tabLPIndiaPackagesNorth" type="full"  maxElements="1"/>
									
									<cms:container name="northViewMoreBtn" type="full"  maxElements="1"/>
									
                                </div>
                            </div>
                                <div class="clearfix"></div>
                            <div class="tabLPIndiaPackages tabLPIndiaPackagesSouth" style="display: none">
                                <div id="tabLPIndiaPackagesSouth" class="tcHolidaysTheamData ">
                                    <cms:container name="tabLPIndiaPackagesSouth" type="full"  maxElements="1"/>
									
									<cms:container name="southViewMoreBtn" type="full"  maxElements="1"/>
                                </div>
                            </div>
                                <div class="clearfix"></div>
                            <div class="tabLPIndiaPackages tabLPIndiaPackagesEast" style="display: none">
                                <div id="tabLPIndiaPackagesEast" class="tcHolidaysTheamData ">
                                    <cms:container name="tabLPIndiaPackagesEast" type="full"  maxElements="1"/>
									<cms:container name="eastViewMoreBtn" type="full"  maxElements="1"/>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="tabLPIndiaPackages tabLPIndiaPackagesWest" style="display: none">
                                <div id="tabLPIndiaPackagesWest" class="tcHolidaysTheamData ">
                                    <cms:container name="tabLPIndiaPackagesWest" type="full"  maxElements="1"/>
									<cms:container name="westViewMoreBtn" type="full"  maxElements="1"/>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="tabLPIndiaPackages tabLPIndiaPackagesAround" style="display: none">
                                <div id="tabLPIndiaPackagesAround" class="tcHolidaysTheamData ">
                                    <cms:container name="tabLPIndiaPackagesAround" type="full"  maxElements="1"/>
									<cms:container name="aroundViewMoreBtn" type="full"  maxElements="1"/>
                                </div>
                            </div>
...
<!------India & Around Holiday Packages Ends from here ------>


<!------Honeymoon Packages start from here------->
<div class="tcHolidaysTheamData">
    <cms:include file="holidaysJSP/holidaysLPHoneymoonPackages.jsp"/>
</div>
<div class="clearfix"></div>
	<div id="holidaysLPHoneymoonPackages" class="CMSTemplates tcHolidaysTheamData holidaysLPHoneymoonPackages">
        <cms:container name="holidaysLPHoneymoonPackages" type="full"  maxElements="1"/>
    </div>
<div class="clearfix"></div>
<!------Honeymoon Packages Ends from here------->
...
<div>
 <h2 class="partner-title">Tourism Board Partners</h2>
        ...
        <div class="row gx-0 justify-content-center">
            <div class="col-xxxl-8 col-xxl-10">
                ...
                <div class="inner__gapTop">
                    ...
                    <%-- Show Load More button only if faqList has more than 5 items --%>
					<%
						if (faqList != null && faqList.size() > 5) {
					%>
					<div class="loadmore_faq text-center mt-4">
						<a href="javascript:void(0)" onclick="fnLoadMoreFAQs('#faqAccordian')" class="btn btn_primary mx-auto">Load More</a>
					</div>
					<%
						}
					%>
...
<script src="/js/tcHolidays/custom.js"></script>
