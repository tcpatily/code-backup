...
//    priceMaxSlider.value = 125000;
    ...
    const minDurationValueDisplay = document.querySelector('#minDurationValueDisplay');
    const maxDurationValueDisplay = document.querySelector('#maxDurationValueDisplay');
