    ...
    <div class="cbt_blc">
        <div class="center_block">
            <div class="ctop_blc">
                <div class="ctl_blc">
                    ...
                    <span v-if="onBehalf !== 'true'">{{ getTourType(tourTypeFilterValue.length > 0 ? parseInt(tourTypeFilterValue[tourTypeFilterValue.length - 1]) : pkgData.minimumPricePackageClassId) }}</span>
                ...
                <div class="select_wrapper" v-if="onBehalf === 'true'">
                    <select 
                        class="form-select onBehalf-select"
                        :value="getOnBehalfSelectValue(pkgData)"
            ...
            <div class="cbtm_blc">
                <div class="cbtm_inr">
                    <span v-if="pkgData.packageDetail.isFlightIncluded == 'Y'"
                        ...
                        data-bs-toggle="modal" :data-bs-target="'#optionalModal-' + pkgData.packageDetail.packageId" data-tab="Flights">
                        <span v-if="pkgData.packageDetail.holidayPlusSubType == 2 || usingJDPrice(pkgData)">Optional</span>
                        <img src="/images/tcHolidays/srp/flights.svg" alt="">
                        Flights
                    </span>
                    <span v-if="isAccommodationIncluded(pkgData)" data-bs-toggle="modal" :data-bs-target="'#optionalModal-' + pkgData.packageDetail.packageId"
                        data-tab="hotels">
                        <img src="/images/tcHolidays/srp/hotel.svg" alt="">
                        Hotels
                    </span>
                    <span v-if="isSightseeingIncluded(pkgData)" data-bs-toggle="modal" :data-bs-target="'#optionalModal-' + pkgData.packageDetail.packageId"
                        data-tab="sightseeing">
                        <img src="/images/tcHolidays/srp/camera.svg" alt="">
                        Sightseeing
                    </span>
                    <span v-if="isVisaIncluded(pkgData)" data-bs-toggle="modal" :data-bs-target="'#optionalModal-' + pkgData.packageDetail.packageId"
                        data-tab="visa2">
                        <img src="/images/tcHolidays/srp/visa.svg" alt="">
                        Visa
                    </span>
                    <span v-if="isMealIncluded(pkgData)" data-bs-toggle="modal" :data-bs-target="'#optionalModal-' + pkgData.packageDetail.packageId"
                        data-tab="meal">
        ...
        <div class="bottom_block">
            ...
            <button v-if="pkgData.packageDetail.srpAction === 'N'"
                @click="bookPkg(pkgData.packageDetail.packageId, pkgData.minimumPricePackageClassId, pkgData.packageDetail.pkgSubtypeId.pkgTypeId, pkgData.packageDetail.pkgName, pkgData.packageDetail)"
                class="btn btn_primary">
                View Details {{pkgData.packageDetail.packageId}}
            </button>
        </div>
    </div>
</div>
...
<!-- Optional Modal -->
<div class="modal fade optional_modal" :id="'optionalModal-' + pkgData.packageDetail.packageId" tabindex="-1" :aria-labelledby="'optionalModalLabel-' + pkgData.packageDetail.packageId"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <ul class="nav nav-tabs" :id="'myTab-' + pkgData.packageDetail.packageId" role="tablist">
                    <li class="nav-item" role="presentation" v-if="pkgData.packageDetail.isFlightIncluded == 'Y'">
                        <button class="nav-link active" :id="'flights-tab-' + pkgData.packageDetail.packageId" data-bs-toggle="tab" :data-bs-target="'#flights-' + pkgData.packageDetail.packageId"
                            type="button" role="tab" :aria-controls="'flights-' + pkgData.packageDetail.packageId" aria-selected="true">
                            <span class="optional">
                    ...
                    <li class="nav-item" role="presentation" v-if="isAccommodationIncluded(pkgData)">
                        <button class="nav-link" :id="'hotels-tab-' + pkgData.packageDetail.packageId" data-bs-toggle="tab" :data-bs-target="'#hotels-' + pkgData.packageDetail.packageId"
                            type="button" role="tab" :aria-controls="'hotels-' + pkgData.packageDetail.packageId" aria-selected="false">
                            <span><img src="assets/img/srp/hotel.svg" alt=""></span>
                            Hotels</button>
                    </li>
                    <li class="nav-item" role="presentation" v-if="isSightseeingIncluded(pkgData)">
                        <button class="nav-link" :id="'sightseeing-tab-' + pkgData.packageDetail.packageId" data-bs-toggle="tab" :data-bs-target="'#sightseeing-' + pkgData.packageDetail.packageId"
                            type="button" role="tab" :aria-controls="'sightseeing-' + pkgData.packageDetail.packageId" aria-selected="false">
                            <span><img src="assets/img/srp/camera.svg" alt=""></span>
                            Sightseeing</button>
                    </li>
                    <li class="nav-item" role="presentation" v-if="isVisaIncluded(pkgData)">
                        <button class="nav-link" :id="'visa2-tab-' + pkgData.packageDetail.packageId" data-bs-toggle="tab" :data-bs-target="'#visa2-' + pkgData.packageDetail.packageId"
                            type="button" role="tab" :aria-controls="'visa2-' + pkgData.packageDetail.packageId" aria-selected="false">
                            <span><img src="assets/img/srp/visa.svg" alt=""></span>
                            Visa</button>
                    </li>
                    <li class="nav-item" role="presentation" v-if="isMealIncluded(pkgData)">
                        <button class="nav-link" :id="'meal-tab-' + pkgData.packageDetail.packageId" data-bs-toggle="tab" :data-bs-target="'#meal-' + pkgData.packageDetail.packageId" type="button"
                            role="tab" :aria-controls="'meal-' + pkgData.packageDetail.packageId" aria-selected="false">
                    ...
                    <li class="nav-item" role="presentation" v-if="pkgData.packageDetail.isTourManagerIncluded == 'Y'">
                        <button class="nav-link" :id="'tour-manager-tab-' + pkgData.packageDetail.packageId" data-bs-toggle="tab"
                            :data-bs-target="'#tour-manager-' + pkgData.packageDetail.packageId" type="button" role="tab" :aria-controls="'tour-manager-' + pkgData.packageDetail.packageId"
                            aria-selected="false">
            ...
            <div class="modal-body">
                <div class="tab-content" :id="'myTabContent-' + pkgData.packageDetail.packageId">
                    <div class="tab-pane fade show active" :id="'flights-' + pkgData.packageDetail.packageId" role="tabpanel" :aria-labelledby="'flights-tab-' + pkgData.packageDetail.packageId">
                        <div class="content_block">
                            <ul>
                                <li>{{pkgData?.packageDetail?.flightDefaultMsg}}</li>
                            </ul>
                        </div>
                    </div>
                    <div class="tab-pane fade" :id="'hotels-' + pkgData.packageDetail.packageId" role="tabpanel" :aria-labelledby="'hotels-tab-' + pkgData.packageDetail.packageId">
                        <div class="content_block">
                            <div class="inr_content">
                                <p>Hotels:</p>
                                <ul>
                                    <span v-for="cat in pkgData.packageDetail.tcilHolidayCategoryCollection.filter(c => c.type === 'Accomodation' && c.isTypeIncluded === 'Y')" :key="cat.categoryId">
                                        <span v-if="cat.type === 'Accomodation' && cat.isTypeIncluded === 'Y'" v-html="cat.typeDefaultMsg"></span>
                                    </span>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" :id="'sightseeing-' + pkgData.packageDetail.packageId" role="tabpanel" :aria-labelledby="'sightseeing-tab-' + pkgData.packageDetail.packageId">
                        <div class="content_block">
                            <div class="inr_content">
                                <ul>
                                    <li v-for="cat in pkgData.packageDetail.tcilHolidayCategoryCollection.filter(c => c.type === 'Sightseeing' && c.isTypeIncluded === 'Y')" :key="cat.categoryId">
                                        <span v-if="cat.type === 'Sightseeing' && cat.isTypeIncluded === 'Y'" v-html="cat.typeDefaultMsg"></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" :id="'visa2-' + pkgData.packageDetail.packageId" role="tabpanel" :aria-labelledby="'visa2-tab-' + pkgData.packageDetail.packageId">
                        <div class="content_block">
                            <ul>
                                <li v-for="cat in pkgData.packageDetail.tcilHolidayCategoryCollection.filter(c => c.type === 'Visa' && c.isTypeIncluded === 'Y')" :key="cat.categoryId">
                                    <span v-if="cat.type === 'Visa' && cat.isTypeIncluded === 'Y'" v-html="cat.typeDefaultMsg"></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="tab-pane fade" :id="'meal-' + pkgData.packageDetail.packageId" role="tabpanel" :aria-labelledby="'meal-tab-' + pkgData.packageDetail.packageId">
                        <div class="content_block">
                            <ul>
                                <li v-for="cat in pkgData.packageDetail.tcilHolidayCategoryCollection.filter(c => c.type === 'Visa' && c.isTypeIncluded === 'Y')" :key="cat.categoryId">
                                    <span v-if="cat.type === 'Visa' && cat.isTypeIncluded === 'Y'" v-html="cat.typeDefaultMsg"></span>
                    ...
                    <div class="tab-pane fade" :id="'tour-manager-' + pkgData.packageDetail.packageId" role="tabpanel" :aria-labelledby="'tour-manager-tab-' + pkgData.packageDetail.packageId">
                        <div class="content_block">
                            <ul>
                                <li>{{pkgData?.packageDetail?.tourManagerDescription}}</li>
                            </ul>
                        </div>
                    </div>
                </div>
