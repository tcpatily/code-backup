...
<body class="holiday-international-page">
...
<div class="tcHolidaysTheamData" id="hero_section-wrapper">
	<c:set var="pageType" value="international" scope="request" />
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-international" role="tabpanel" aria-labelledby="pills-international-tab">
                                <div class="CMSTemplates tcHolidaysTheamData holidaysLPTrendingInternationalSection">
                                    <cms:container name="holidaysLPTrendingInternationalSectionInternational" type="full"  maxElements="1"/>
                                </div>
                                <div class="inner__gapTop" style="display: none;">
            ...
            <div class="row gx-0 justify-content-center best_selling">
                <div class="col-xxxl-9 col-xxl-12">
                    <div class="main_heading ">
						...
						<div class="clearfix"></div>
                    <div class="inner__gapTop ">
					<div class="holidaysLPBestSellingPackagesTab tabBestSellingTabInternational d-block">
					<div class="clearfix"></div>
...
<!------Explore Holidays By Theme start from here------->
	<div id="holidaysLPExploreHolidaysByTheme" class="container tcHolidaysTheamData holidaysLPExploreHolidaysByTheme holiday_theme rn__section__gapTop">
        <cms:container name="holidaysLPInternationalExploreHolidaysByTheme" type="full"  maxElements="1"/>
    </div>
    <div class="clearfix"></div>
<!------Explore Holidays By Theme start from here------->
...
<!------International Packages start from here ------->
    ...
    <div class="visa_package  rn__section__gapTop">
        <div class="container">
            <div class="row gx-0 justify-content-center">
                <div class="col-xxxl-9 col-xxl-12">
                    <div class="main_heading ">
                        <h2>Easy Visa Holidaysy</h2>
                        
                    </div>
						<div class="clearfix"></div>
                        <div class="inner__gapTop ">
                            <div class="tabLPInternationalPackages  d-block">
                                <div class="clearfix"></div>
                                <div id="" class="tcHolidaysTheamData ">
                                    <cms:container name="tabLPInternationalPackages" type="full"  maxElements="1"/>
                                </div>
								 <div class="inner__gapTop" >
                                    <a href="international.html" class="btn btn_primary m-auto">View All <img src="../images/tcHolidays/arrow-narrow-up-right.svg" alt=""></a>
                                </div>
...
<!------International Packages start from here ------->
    ...
    <div class="international_package package-for-int-page rn__section__gapTop">
        <div class="container">
            <div class="row gx-0 justify-content-center">
                <div class="col-xxxl-9 col-xxl-12">
                    <div class="main_heading ">
						...
						<div class="clearfix"></div>
                        <div class="inner__gapTop ">
                            <div class="tabLPInternationalPackages tabLPInternationalPackagesEurope">
                                <div class="clearfix"></div>
...
<div class="tcHolidaysTheamData">
    <cms:include file="internationalHolidaysJSP/holidaysLPHoneymoonPackages.jsp"/>
</div>
<div class="clearfix"></div>
...
<div class="tcHolidaysTheamData">
    <cms:include file="internationalHolidaysJSP/holidaysLPYourDailyDoseofWanderlust.jsp"/>
</div>
<div class="clearfix"></div>
...
<div class="tcHolidaysTheamData vertical_tabs_section d-none">	      
	<div class="container">
...
<div class="tcHolidaysTheamData">
    <cms:include file="internationalHolidaysJSP/holidaysLPToursAndTravelAgencyThomasCookIndia.jsp"/>
</div>
<div class="clearfix"></div>
...
<div class="tcHolidaysTheamData">
    <cms:include file="internationalHolidaysJSP/holidaysFixedButton.jsp"/>
</div>
<div class="clearfix"></div>
...
<div class="tcHolidaysTheamData">
    <cms:include file="internationalHolidaysJSP/vendorScript.jsp"/>
</div>
